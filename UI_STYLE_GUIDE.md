...
// Gradient text
className =
  "bg-gradient-to-r from-violet-600 via-fuchsia-600 to-cyan-600 bg-clip-text text-transparent";
...
className =
  "bg-gradient-to-r from-brand-50 to-brand-100 border border-brand-200";
```
...
className =
  "bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl";

// Tenant (dark, elegant)
className =
  "bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-200/50";
```
