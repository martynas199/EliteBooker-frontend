      ...
      >
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg hover:from-emerald-700 hover:to-teal-700 shadow-lg"
                >
                  Start Free Trial <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white text-emerald-600 font-semibold rounded-lg border-2 border-emerald-600 hover:bg-emerald-50"
                >
                  Book a Demo
                </Link>
              </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-emerald-600">
              ...
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> Unlimited
                  bookings & clients
                </li>
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> Unlimited
                ...
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> SMS reminders
                  (£2.99/month optional add-on)
                </li>
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> Deposit
                  protection
                </li>
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> Integrated
                  POS
                </li>
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> Gift cards &
                  loyalty
                </li>
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> Business
                  reporting
                </li>
                <li className="flex items-center">
                  <span className="text-emerald-600 mr-2">✓</span> No commission
                  fees ever
                </li>
              </ul>
              <Link
                to="/signup"
                className="w-full inline-flex items-center justify-center px-8 py-4 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700"
              >
                Start Free Trial
              </Link>
            </div>
