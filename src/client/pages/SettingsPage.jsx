        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
              ...
              <p className="font-medium text-gray-900">{client?.name || "Not set"}</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-1">Email</p>
              <p className="font-medium text-gray-900 break-all">{client?.email || "Not set"}</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-1">Phone</p>
              <p className="font-medium text-gray-900">{client?.phone || "Not set"}</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-1">Account</p>
              <p className="font-medium text-gray-900">{client ? "Signed in" : "Signed out"}</p>
            </div>
          </div>

          <div className="flex flex-wrap gap-3">
            <Button variant="secondary" onClick={refreshProfile}>Refresh profile</Button>
