    ...
    async function loadData() {
      try {
        ...
        const categories = new Set(
          activeServices.map((s) => s.category).filter(Boolean)
        );
        setStats({
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      initial={{ x: "-100%" }}
                      animate={
                        hoveredService === service._id ? { x: "200%" } : {}
                      }
                      transition={{ duration: 0.8 }}
                    />
            ...
            {[
              {
                ...
                description:
                  "Our skilled specialists bring years of experience and passion to every treatment",
              ...
              },
              {
                ...
                title: "Easy Booking",
                description:
                  "Book your appointment online 24/7 with instant confirmation",
              ...
              },
              {
                ...
                description:
                  "We use only the finest products and latest techniques for exceptional results",
          ...
          <Card className="relative bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 text-white p-12 md:p-16 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
                Choose your preferred service and time slot. Easy online booking
